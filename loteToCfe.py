...
def XmlCfe(lote):
	...
	patternCanc = ['^\<\?xml version="1.0" encoding="UTF-8"\?\>\<cancCFe xmlns="http://www.fazenda.sp.gov.br/sat" versao="\d{1,}.\d{1,}"\>','^\<\?xml version="1.0" encoding="UTF-8"\?\>\<cancCFe versao="\d{1,}.\d{1,}" xmlns="http://www.fazenda.sp.gov.br/sat"\>','\<cancCFe versao="\d{1,}.\d{1,}" xmlns="http://www.fazenda.sp.gov.br/sat"\>']
